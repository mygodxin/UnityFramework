...
namespace HS
{
    ...
    public class GTweener
    {
        ...
        public void _Update(float dt = 0)
        {
        ...
        void CallStartCallback()
        {
            if (GTween.catchCallbackExceptions)
            {
                ...
                {
                    Debug.LogWarning("HS: error in start callback > " + e.Message);
                }
            }
            else
            {
        ...
        void CallUpdateCallback()
        {
            if (GTween.catchCallbackExceptions)
            {
                ...
                {
                    Debug.LogWarning("HS: error in update callback > " + e.Message);
                }
            }
            else
            {
        ...
        void CallCompleteCallback()
        {
            if (GTween.catchCallbackExceptions)
            {
                ...
                {
                    Debug.LogWarning("HS: error in complete callback > " + e.Message);
                }
            }
            else
            {
