...
namespace UIBind
{
    ...
    {
        private static readonly string[] EditorAssemblyNames = { "Assembly-CSharp-Editor","Assembly-CSharp-Editor-firstpass" };
        private static readonly string[] RuntimeAssemblyNames = { "Assembly-CSharp" };
